# Autogenerated wrapper script for Libgpg_error_jll for x86_64-w64-mingw32
export libgpg_error
...
const libgpg_error_splitpath = ["bin", "libgpg-error6-0.dll"]
...
const libgpg_error = "libgpg-error6-0.dll"

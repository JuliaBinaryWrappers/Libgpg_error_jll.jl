# Autogenerated wrapper script for Libgpg_error_jll for x86_64-apple-darwin14
export libgpg_error
...
const libgpg_error_splitpath = ["lib", "libgpg-error.0.dylib"]
...
const libgpg_error = "@rpath/libgpg-error.0.dylib"
